...
public class UpdateTransactions {
    ...
    public  String updateTransaction(String token) throws IOException {
        ...
        try(DataOutputStream os = new DataOutputStream(connection.getOutputStream())){
            ArrayList<String> transaction_id = this.transaction_id;
            String filter_type = "transaction_id";

            String idJsonArrayContent = transaction_id.stream()
                    .map(s -> "\"" + s + "\"")
    ...
    public static void main(String[] args) throws IOException {
        ...
        String generate = generate_operation.postPaylink(token);
        UpdateTransactions update_operation = new UpdateTransactions(operations);
